...
let seeingWorld = ["USA", "Japan", "Switzerland", "Israel", "Netherland"];
console.log(seeingWorld); // (Print array in its original order.)
let sortedArray = [...seeingWorld].sort();
...
let reverseSorted = [...seeingWorld].sort().reverse();
...
let reverseAlphabatical = seeingWorld.reverse();
