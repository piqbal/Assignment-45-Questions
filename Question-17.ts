...
// new line that prints a message saying that you can invite only two people for dinner.
...
console.log(`Sorry ${friends.pop()}, I can't invite you to dinner due to some reason.`)
console.log(`Sorry ${friends.pop()}, I can't invite you to dinner due to some reason.`)
console.log(`Sorry ${friends.pop()}, I can't invite you to dinner due to some reason.`)
console.log(`Sorry ${friends.pop()}, I can't invite you to dinner due to some reason.`)

// Print a message to each of the two people still on your list that you are invited.

for(let i=0; i<friends.length; i++){
    console.log(`Hello ${friends[i]}, You are still invited to dinner tonight.`)}
